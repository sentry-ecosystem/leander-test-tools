...
def before_send(event, hint):
    ...
    if transaction.startswith("test-transaction-") or culprit.startswith("test-transaction-"):
        return None
    tags = event.get("tags", {})
    if isinstance(tags, dict) and tags.get("Generated By") == "error-generator.sentry.dev":
        return None
    return event
